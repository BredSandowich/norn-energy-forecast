...
#Pull data from Government of Canada historical weather data (hourly temp, wind, precip) for Edmonton and Calgary airports.
raw_dir = Path("data/raw")
...
#Clean and merge datasets, create features for modeling, and save to processed directory for modeling notebooks
raw_dir = Path("data/raw")
